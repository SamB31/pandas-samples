        ...
        for file in os.listdir(folder):
            ...
            if file.endswith(".xlsx"):
                ...
                for q in quarter:
                    ...
                    payroll_sum = round(df1[(df1['Quarter'] == q) & (df1['Date'] >= '2020-10-01')]['Gross Wages'].sum(), 2)
                    ...
                    comp_sum = round(df2[(df2['Quarter'] == q_year)]['Payroll'].sum(), 2)
                    ...
                    if payroll_sum > report:
                        ...
                        print(f"{q} does not require altering.\n")
                        count +=1
                        continue
                ...
                if count < 4: 
                    ...
                    print("\nCSV created no Columns need to be adjusted\n\n-------------------------------------------------------------------------\n")
                    df1['Gross Wages'] = df1['Gross Wages']
                    df_subset = df1[['Date', 'Quarter', 'Year', 'Name', 'Gross Wages']]
                    name2 = f"{name2}.csv"
                    df_subset.to_csv(os.path.join(full, name2), index=False, header=True)
